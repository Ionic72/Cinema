    ...
    public class CATEGORIA_PELICULALN
    {
        ...
        public static CATEGORIA_PELICULALN Instancia
        {
            get
            {
                if(instancia == null)
                {
                    instancia = new CATEGORIA_PELICULALN();
                }
                return instancia;
            }
        }
        ...
        public void AgregarCategoria(CATEGORIA_PELICULA newCategoriaPelicula)
        {
            ...
            {
                if(CategoriaPelicula[i] == null)
                {
                    CategoriaPelicula[i] = newCategoriaPelicula;
                    return;
                }
            }
        ...
        {
            foreach (var categoria in CategoriaPelicula)
            {
                if(categoria == null) { return; }
                if(categoria.CategoriaID == newCategoriaPelicula.CategoriaID || categoria.NombreCategoria == newCategoriaPelicula.NombreCategoria)
                {
        ...
        public CATEGORIA_PELICULA[] ObtenerCategorias()
        {
            if (CategoriaPelicula.All(c => c == null))
            {
